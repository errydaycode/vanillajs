...
// То есть функция могла бы вернуть нам конкретные данные, которые мы от неё просим, но она возвращает обещание (1111.ts) эти данные вернуть, но чуть-чуть попозже.
